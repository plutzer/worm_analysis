import os
from code import aggregates_algorithms
from skimage.io import imread
import csv

directories = ['/scratch/plutzer/Aggregates_training_data/sorter_images','/scratch/plutzer/Aggregates_training_data/Worm1','/scratch/plutzer/Aggregates_training_data/Worm2','/scratch/plutzer/Aggregates_training_data/Worm3','/scratch/plutzer/Aggregates_training_data/Worm4']## Change this
